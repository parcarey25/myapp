...
<nav class="navbar navbar-dark" style="background:linear-gradient(90deg,#000,#b30000)">
  <a class="navbar-brand ml-3" href="admin_dashboard.php">
    <img src="photo/logo.jpg" height="32" class="mr-2" alt="RJL Admin">RJL Admin
  </a>
